package com.destinyapp.mading.Adapter.Spinner;
...
public class AdapterSpinnerJurusan extends ArrayAdapter<DataModel> {

    public AdapterSpinnerJurusan(Context context, List<DataModel> list) {
